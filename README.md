...
## Documentation 
Please consult the [online documentation]{http://oguyon.github.io/Cfits/} (generated by doxygen).
ddConsult the [quick help](../doc/help.txt) file for a quick guide to using the command line interface and using help commands.
