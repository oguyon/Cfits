        ...
        if(k<kold)
        {
            ...
            if(kold>0)
            {
                for(ii=0; ii<xysize; ii++)
                {
					v0 = 0.0;
					v1 = 0.0;
                   data.image[IDavek].array.F[ii] /= (data.image[IDavecnt].array.U[ii]+1.0);
                   data.image[IDavev].array.F[ii] /= (data.image[IDavecnt].array.U[ii]+1.0);
                   for(kk=1; kk<data.image[IDavecnt].array.U[ii]; kk++)
                           {
