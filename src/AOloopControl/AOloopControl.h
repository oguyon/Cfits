...
long Measure_zonalRM(long loop, double ampl, long delayfr, long RMdelay1us, long NBave, long NBexcl, char *zrespm_name, char *WFSref_name, char *WFSmap_name, char *DMmap_name, long mode, int normalize, int AOinitMode);
