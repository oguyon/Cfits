...
long Measure_zonalRM(long loop, double ampl, long delayfr, long NBave, char *zrespm_name, char *WFSref_name, char *WFSmap_name, char *DMmap_name, long mode, int normalize, int ASYNC);
